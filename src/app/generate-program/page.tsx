...
const GenerateProgramPage = () => {
  ...
  //naviate user to profile page after call ends
  useEffect(() => {
    if (callEnded) {
  ...
  return (
    <div className="flex flex-col min-h-screen text-foreground overflow-hidden pb-6 pt-4">
              ...
              {messages.map((msg, index) => (
                <div key={index} className="message-item animate-fadeIn">
                  <div className="font-semibold text-xs text-muted-foreground mb-1">
                    {msg.role === "assistant" ? "NeuralFit AI" : "You"}:
                  </div>
